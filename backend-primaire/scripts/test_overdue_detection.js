...
async function testOverdueDetection() {
    try {
        ...
        const loginResponse = await axios.post('https://trayebernard-primaire.com/api/auth/login', {
        ...
        const statsResponse = await axios.get('https://trayebernard-primaire.com/api/reminders/statistics', {
            headers,
        ...
        const allOverdueResponse = await axios.get('https://trayebernard-primaire.com/api/reminders/all-school/overdue', {
            headers,
            params: { school_year: '2025-2026' }
        });
        ...
        if (allOverdueStudents.length > 0) {
            ...
            const classResponse = await axios.get('https://trayebernard-primaire.com/api/classes', { headers });
            ...
            if (targetClass) {
                ...
                const classOverdueResponse = await axios.get(`https://trayebernard-primaire.com/api/reminders/class/${targetClass.id}/overdue`, {
                    headers,
                    params: { school_year: '2025-2026' }
                });
            ...
            const installmentsResponse = await axios.get('https://trayebernard-primaire.com/api/installments/student/8', {
                headers,
                params: { school_year: '2025-2026' }
            });
