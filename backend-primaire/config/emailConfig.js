...
module.exports = {
    emailConfig: {
        ...
        host: process.env.SMTP_HOST || 'mail.trayebernard-primaire.com',
        port: parseInt(process.env.SMTP_PORT) || 465,
        secure: true, // Port 465 nécessite SSL/TLS
        auth: {
            user: process.env.MAIL_USER || 'infos@trayebernard-primaire.com',
    ...
    frontendUrl: process.env.FRONTEND_URL || 'https://trayebernard-primaire.com',
