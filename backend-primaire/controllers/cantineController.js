...
module.exports = {
        ...
        getCantineStudents: async(req, res) => {
            try {
                ...
                // Récupérer tous les élèves inscrits à la cantine (étudiants + garderie)
        ...
        getCantineStats: async(req, res) => {
            ...
            try {
                ...
                // 1. Compter le total des élèves inscrits à la cantine (étudiants + garderie)
            ...
            `);
                ...
                studentsWithClasses.forEach(student => {
                    ...
                    if (student.source_type === 'garderie') {
                        ...
                        // Pour les étudiants normaux, utiliser la logique existante
