...
const discountController = {
    ...
    // Obtenir tous les bons/prises en charge des étudiants
    ...
    // Obtenir les bons/prises en charge d'un étudiant spécifique
    ...
    // Obtenir les informations d'un étudiant avec sa classe et scolarité
    ...
    // Créer un nouveau bon/prise en charge pour un étudiant
    createStudentDiscount: async(req, res) => {
        ...
        if (!student_id || !discount_type_id || !amount) {
            return res.status(400).json({
                message: 'L\'ID étudiant, le type de réduction et le montant sont requis.'
            });
        }
        ...
        try {
            ...
            // Récupérer les informations de l'étudiant et de sa classe
    ...
    // Calculer le montant total des réductions actives pour un étudiant
    ...
    applyDiscountsToPayment: async(req, res) => {
        ...
        if (!payment_id || !student_id) {
            return res.status(400).json({
                message: 'L\'ID du paiement et l\'ID de l\'étudiant sont requis.'
            });
        }
        ...
        try {
            ...
            // Récupérer les réductions actives de l'étudiant
            const currentDate = new Date().toISOString().split('T')[0];
