...
const getClassCompositionReport = async(req, res) => {
    ...
    `;
        ...
        // Récupérer les résultats des étudiants avec toutes les matières
        const resultsQuery = `
      SELECT 
        st.id,
        st.first_name,
...
const getSchoolCompositionReport = async(req, res) => {
    ...
    `;
        ...
        // Récupérer les résultats de tous les étudiants de toutes les classes des niveaux concernés
        const resultsQuery = `
      SELECT 
        st.id,
        st.first_name,
