...
try {
    ...
    // Récupérer tous les étudiants de la classe avec email parent
    ...
    console.log(`[BULLETIN CONTROLLER] ${students.length} étudiants trouvés avec email parent`);
    ...
    if (compositionInfo.length > 0) {
        ...
        // Pour chaque étudiant, récupérer son bulletin et l'envoyer
        for (const student of students) {
            try {
                ...
                emailsFailed++;
                console.error(`[BULLETIN CONTROLLER] Erreur pour l'étudiant ${student.id}:`, studentError);
            }
        }
