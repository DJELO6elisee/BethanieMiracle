...
router.post('/', checkRole(['admin', 'secretary', 'informaticien']), compositionController.createComposition);
router.put('/:id', checkRole(['admin', 'secretary', 'informaticien']), compositionController.updateComposition);
router.delete('/:id', checkRole(['admin', 'secretary', 'informaticien']), compositionController.deleteComposition);
router.patch('/:id/toggle', checkRole(['admin', 'secretary', 'informaticien']), compositionController.toggleComposition);
