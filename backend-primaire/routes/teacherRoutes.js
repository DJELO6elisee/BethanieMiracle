...
router.get('/', checkRole(['admin', 'secretary']), teacherController.getAllTeachers);
router.get('/:id', checkRole(['admin', 'secretary']), teacherController.getTeacherById);
...
router.post('/', checkRole(['admin', 'secretary']), teacherController.createTeacher);
router.put('/:id', checkRole(['admin', 'secretary']), teacherController.updateTeacher);
router.delete('/:id', checkRole(['admin', 'secretary']), teacherController.deleteTeacher);

// Route pour ajouter une note à un élève pour une classe (sans évaluation)
router.post('/grades', checkRole(['teacher', 'admin', 'secretary', 'informaticien']), teacherController.addGrade);

// Route pour récupérer les notes d'une classe/matière/trimestre
router.get('/grades', checkRole(['teacher', 'admin', 'secretary', 'informaticien']), teacherController.getGradesByClassSubject);
...
router.get('/authorized-subjects/:classId', checkRole(['teacher', 'admin', 'secretary', 'informaticien']), teacherController.getAuthorizedSubjectsForClass);

// Route pour publier les notes
router.post('/publish-grades', checkRole(['teacher', 'admin', 'secretary', 'informaticien']), teacherController.publishGrades);
