...
// Routes pour l'admin
router.post('/upload', auth, checkRole(['admin', 'secretary', 'informaticien']), upload.single('media'), mediaController.uploadMedia);
router.get('/admin/all', auth, checkRole(['admin', 'secretary', 'informaticien']), mediaController.getAllMedia);
router.delete('/:id', auth, checkRole(['admin', 'secretary', 'informaticien']), mediaController.deleteMedia);
router.post('/:id/send-to-parents', auth, checkRole(['admin', 'secretary', 'informaticien']), mediaController.sendMediaToParents);

// Route pour servir les médias protégés (accessible avec token)
router.get('/:id', mediaController.getProtectedMedia);

// Routes existantes pour les médias étudiants
...
router.get('/student/:student_id', auth, checkRole(['admin', 'secretary', 'teacher', 'parent', 'informaticien']), mediaController.getStudentMedia);
