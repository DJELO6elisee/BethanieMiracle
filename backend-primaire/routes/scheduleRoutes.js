...
router.post('/create-weekly', auth, checkRole(['teacher', 'admin', 'secretary', 'informaticien']), scheduleController.createWeeklySchedule);

// Route pour publier l'emploi du temps hebdomadaire pour les parents
router.post('/publish-weekly', auth, checkRole(['teacher', 'admin', 'secretary', 'informaticien']), scheduleController.publishWeeklySchedule);

// Route pour modifier un emploi du temps hebdomadaire
router.put('/update-weekly/:id', auth, checkRole(['teacher', 'admin', 'secretary', 'informaticien']), async(req, res) => {
    try {
        const { id } = req.params;
...
router.delete('/delete-weekly/:id', auth, checkRole(['teacher', 'admin', 'secretary', 'informaticien']), async(req, res) => {
    try {
        const { id } = req.params;
...
router.get('/weekly-schedule/:classId', auth, checkRole(['teacher', 'admin', 'secretary', 'informaticien']), async(req, res) => {
    try {
...
router.post('/publish-weekly-schedule', auth, checkRole(['teacher', 'admin', 'secretary', 'informaticien']), async(req, res) => {
    try {
