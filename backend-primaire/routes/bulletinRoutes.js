...
if (controllerLoadError || !bulletinController) {
    ...
    router.get('/class/:classId/status', checkRole(['admin', 'secretary', 'informaticien']), errorHandler);
    router.get('/class/:classId/students', checkRole(['admin', 'secretary', 'informaticien']), errorHandler);
    router.post('/class/:classId/publish', checkRole(['admin', 'secretary', 'informaticien']), errorHandler);
    router.post('/class/:classId/unpublish', checkRole(['admin', 'secretary', 'informaticien']), errorHandler);
...
router.get('/class/:classId/status',
    checkRole(['admin', 'secretary', 'informaticien']),
