...
if (fs.existsSync(manifestPath)) {
    ...
    manifest.description = `Groupe Scolaire Béthanie Miracle - Compatible Safari - Mise à jour du ${now.toLocaleDateString('fr-FR')}`;
...
const versionInfo = {
    ...
    description: 'Groupe Scolaire Béthanie Miracle - Version PWA'
};
