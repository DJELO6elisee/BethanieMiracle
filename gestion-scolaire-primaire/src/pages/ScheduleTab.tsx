  ...
  useEffect(() => {
    ...
    const fetchSchedules = async () => {
      ...
      try {
        ...
        const officialResponse = await axios.get(`https://bethaniemiracle.com/api/students/${childId}/schedule?school_year=${schoolYear}`, {
        ...
        console.log('URL:', `https://bethaniemiracle.com/api/students/${childId}/weekly-schedule?school_year=${schoolYear}`);
        console.log('Token présent:', !!token);
        console.log('Token complet:', token);
        console.log('Child ID:', childId);
        console.log('School Year:', schoolYear);
        
        const weeklyResponse = await axios.get(`https://bethaniemiracle.com/api/students/${childId}/weekly-schedule?school_year=${schoolYear}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
