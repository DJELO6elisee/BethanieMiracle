        ...
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            ...
            <List sx={{ pl: 0 }}>
              ...
              <ListItem sx={{ px: 0, py: 0.5 }}>
                <ListItemText
                  primary="• 1 fiche d'identification et 1 fiche de santé à retirer à La Petite académie"
                  sx={{
                    '& .MuiListItemText-primary': {
                      fontSize: { xs: 14, md: 16 },
                      color: '#333',
        ...
        <Box sx={{
          ...
          <Box sx={{ mb: 2 }}>
              ...
              <Table size="small">
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell sx={{ fontSize: { xs: 12, md: 14 } }}>A L'ORDRE DE LA MAISON DES ENFANTS-LA PETITE ACADEMIE</TableCell>
                    <TableCell sx={{ fontSize: { xs: 12, md: 14 } }}>-</TableCell>
                    <TableCell sx={{ fontSize: { xs: 12, md: 14 } }}>-</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ fontSize: { xs: 12, md: 14 }, fontWeight: 600 }}>DÉPÔT BANCAIRE</TableCell>
                    <TableCell sx={{ fontSize: { xs: 12, md: 14 } }}>LA MAISON DES ENFANTS-LA PETITE ACADEMIE</TableCell>
            ...
            <Typography sx={{ fontSize: { xs: 14, md: 16 }, mb: 2, lineHeight: 1.6 }}>
              Toujours préciser sur le bordereau du versement le nom, le prénom et la classe de l'enfant. Se présenter avec le justificatif du versement sur le compte, à la caisse de l'école de LA MAISON DES ENFANTS -LA PETITE ACADÉMIE ou le transmettre par mail ou par WhatsApp dans un bref délais au service comptable (infos@lapetiteacademie.ci) afin de valider le paiement et rendre effective l'admission en classe.
            </Typography>
              ...
              <Grid item xs={12} md={6}>
                <Box sx={{
                  ...
                  <List sx={{ pl: 0 }}>
                    ...
                    <ListItem sx={{ px: 0, py: 0.5 }}>
                      <ListItemText
                        primary="• 1 Fiche d'identification à récupérer à la petite Académie"
                        sx={{
                          '& .MuiListItemText-primary': {
                            fontSize: { xs: 14, md: 16 },
                            color: '#333',
                    ...
                    <ListItem sx={{ px: 0, py: 0.5 }}>
                      <ListItemText
                        primary="• 1 fiche Sanitaire à récupérer à la Petite Académie"
                        sx={{
                          '& .MuiListItemText-primary': {
                            fontSize: { xs: 14, md: 16 },
                            color: '#333',
          ...
          <Box sx={{ mb: 2 }}>
            <Typography sx={{ fontSize: { xs: 14, md: 16 }, mb: 1 }}>
              Crèche/maternelle la Maison des enfants-la Petite Académie, Angré 8è tranche, 06 BP 1980 Abidjan 06
            </Typography>
...
const Scolarite = () => {
  return (
    <>
      <Helmet>
        <title>Crèche Garderie TPS Abidjan - Groupe Scolaire Béthanie Miracle | Inscription 2025-2026</title>
        <meta name="description" content="Crèche et garderie TPS à Abidjan Cocody II Plateau Agban. Le Groupe Scolaire Béthanie Miracle accueille les tout-petits de 3 mois à 3 ans dans un environnement bienveillant avec pédagogie alternative et programme bilingue français-anglais. École sans distinction. Inscription 2025-2026." />
        <meta name="keywords" content="crèche TPS Abidjan, garderie TPS Cocody, crèche 3 mois 3 ans, garderie bébé Abidjan, pédagogie alternative crèche, programme bilingue crèche, inscription crèche 2025, Groupe Scolaire Béthanie Miracle, crèche privée Plateau Agban, éveil bébé, développement tout-petit, école sans distinction" />
        <meta property="og:title" content="Crèche Garderie TPS Abidjan - Groupe Scolaire Béthanie Miracle | Inscription 2025-2026" />
        <meta property="og:description" content="Crèche et garderie TPS à Abidjan Cocody II Plateau Agban. Le Groupe Scolaire Béthanie Miracle accueille les tout-petits de 3 mois à 3 ans avec pédagogie alternative et programme bilingue." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bethaniemiracle.com/scolarite" />
        <link rel="canonical" href="https://bethaniemiracle.com/scolarite" />
      </Helmet>
      <Box sx={{ 
        width: '100%',
        margin: 0,
