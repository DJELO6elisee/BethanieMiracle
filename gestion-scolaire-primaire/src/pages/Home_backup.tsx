                  ...
                  <Table size="small">
                    <TableHead>
                      <TableRow sx={{ bgcolor: '#f5f5f5' }}>
                        ...
                        <TableCell sx={{ fontWeight: 'bold' }}>A L'ORDRE DE LA MAISON DES ENFANTS-LA PETITE ACADEMIE</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      <TableRow>
            ...
            <Paper sx={{ p: 3, bgcolor: '#f8f9fa' }}>
              <List>
                ...
                <ListItem sx={{ display: 'flex', alignItems: 'flex-start' }}>
                  ...
                  <ListItemText primary="1 Fiche d'Identification et 1 fiche Sanitaire à récupérer à la Petite Académie" />
                </ListItem>
              </List>
            </Paper>
          </Box>
