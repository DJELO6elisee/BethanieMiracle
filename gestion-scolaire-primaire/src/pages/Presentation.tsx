          ...
          <Grid container spacing={4} alignItems="flex-start">
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{
                ...
                >
                  La Maison des Enfants – La Petite Académie est un centre d'accueil de la petite enfance, 
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <img
                    src="/img/pages/9.jpg"
                    alt="Cérémonie de graduation - La Petite Académie"
                    style={{
                      width: '100%',
                      height: 'auto',
                      display: 'block',
          ...
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <img
                    src="/img/pages/76.jpg" // Remplacer par l'image des enfants avec l'activité
                    alt="Enfants en activité éducative - La Petite Académie"
                    style={{
                      width: '100%',
                      height: 'auto',
                      display: 'block',
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{
                ...
                >
                  À La Maison des Enfants – La Petite Académie, nous imaginons un monde où chaque enfant 
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <img
                    src="/img/pages/142.jpg" // Remplacer par l'image de graduation
                    alt="Cérémonie de graduation - La Petite Académie"
                    style={{
                      width: '100%',
                      height: 'auto',
            ...
            <Grid item xs={12} md={5}>
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <img
                    src="/img/pages/76.jpg" // Remplacer par l'image de la cour de récréation
                    alt="Cour de récréation - La Petite Académie"
                    style={{
                      width: '100%',
                      height: '100%',
                      display: 'block',
...
const Presentation = () => {
  return (
    <>
      <Helmet>
        <title>Présentation - École Maternelle et Primaire Bilingue Abidjan | Groupe Scolaire Béthanie Miracle</title>
        <meta name="description" content="Découvrez le Groupe Scolaire Béthanie Miracle : notre vision, nos missions et nos valeurs. École sans distinction de race ni de religion, maternelle et primaire bilingue à Abidjan Cocody II Plateau Agban avec pédagogie alternative et programme français-anglais." />
        <meta name="keywords" content="présentation école maternelle Abidjan, présentation école primaire Abidjan, vision pédagogique, missions école, valeurs éducation, pédagogie alternative, programme bilingue, école maternelle privée Cocody, école primaire privée Cocody, Groupe Scolaire Béthanie Miracle, école sans distinction" />
        <meta property="og:title" content="Présentation - École Maternelle et Primaire Bilingue Abidjan | Groupe Scolaire Béthanie Miracle" />
        <meta property="og:description" content="Découvrez le Groupe Scolaire Béthanie Miracle : notre vision, nos missions et nos valeurs. École sans distinction de race ni de religion, maternelle et primaire bilingue à Abidjan." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bethaniemiracle.com/presentation" />
        <link rel="canonical" href="https://bethaniemiracle.com/presentation" />
      </Helmet>
      <Box sx={{ 
        width: '100%',
        margin: 0,
