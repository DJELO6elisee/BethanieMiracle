    ...
    const fetchStudentDetails = async () => {
      ...
      try {
        ...
        const [studentData, discountsData] = await Promise.all([
          axios.get(`https://bethaniemiracle.com/api/students/${id}/details?school_year=${schoolYear}`, {
            headers: { Authorization: `Bearer ${token}` }
          }),
          axios.get(`https://bethaniemiracle.com/api/discounts/student/${id}`)
        ]);
        if (isMounted) {
                    ...
                    <Box sx={{ position: 'relative', mr: 2 }}>
                      <img
                        ...
                        onError={(e) => {
                          ...
                          console.error('🔗 URL tentée:', `https://bethaniemiracle.com/api/students/photo/${student.child_photo}`);
