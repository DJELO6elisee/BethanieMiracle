...
const HomepageManagement = () => {
    ...
    try {
      ...
      if (uploadMethod === 'upload') {
        ...
        response = await axios.post(
          `https://bethaniemiracle.com/api/homepage/activities/${selectedActivity.id}/images/upload`,
          formData,
          { headers }
        );
      } else {
        ...
        response = await axios.post(
          `https://bethaniemiracle.com/api/homepage/activities/${selectedActivity.id}/images/url`,
          {
            image_url: imageUrl,
  ...
  const handleDeleteImage = async (imageId: number) => {
    ...
    try {
      const token = localStorage.getItem('token');
      await axios.delete(
        `https://bethaniemiracle.com/api/homepage/activity-images/${imageId}`,
        {
              ...
              <Box sx={{ mb: 3 }}>
               ...
               <Box>
                 ...
                 <Box sx={{ mb: 2 }}>
                   ...
                   <Typography variant="caption" color="primary" sx={{ display: 'block', mb: 1 }}>
                     • Images de votre site : https://bethaniemiracle.com/img/pages/example.jpg
                   </Typography>
