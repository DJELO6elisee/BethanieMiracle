...
const GestionEleves = () => {
    ...
    const fetchStudents = async (currentFilters = filters) => {
        ...
        try {
            ...
            const response = await axios.get('https://bethaniemiracle.com/api/students', { headers, params });
    ...
    useEffect(() => {
        ...
        const fetchInitialData = async () => {
            ...
            try {
                ...
                const classesPromise = axios.get('https://bethaniemiracle.com/api/classes', { headers });
                const studentsPromise = axios.get('https://bethaniemiracle.com/api/students', { headers, params: { school_year: schoolYear } });
    ...
    const generateExcelWorkbook = () => {
        ...
        const schoolInfo = [
            ...
            ['', '', '', '', '', ''],
            ['N°', 'Matricule', 'Nom et Prénom', 'Classe', 'Genre', 'Numéro Parent', 'Date de naissance']
        ];
                        ...
                        @media print {
                            ...
                            * {
                            ...
                            .MuiTableBody-root .MuiTableCell-root:nth-child(3) {
                                width: 35% !important; /* Nom et Prénom */
                            }
