  ...
  const handleWeekChange = (week: 'current' | 'next') => {
    ...
    const loadTitleForWeek = async () => {
      ...
      try {
        ...
        const { data } = await axios.get(`https://bethaniemiracle.com/api/schedules/weekly-schedule/${selectedClass.id}`, {
...
const TeacherDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (user.role === 'teacher') {
      const token = localStorage.getItem('token');
      axios.get('https://bethaniemiracle.com/api/teachers/me', {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then(res => {
        if (isMounted) {
  ...
  const fetchMySubjects = async () => {
    try {
      const token = localStorage.getItem('token');
      const { data } = await axios.get(`https://bethaniemiracle.com/api/teachers/${teacher?.id}/subjects`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const loadTeacherClasses = async () => {
    try {
      ...
      const { data } = await axios.get(`https://bethaniemiracle.com/api/teachers/classes`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleSelectSubject = async (subject: Subject) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const { data } = await axios.get(`https://bethaniemiracle.com/api/teachers/${teacher?.id}/subjects/${subject.id}/classes`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleSelectClass = async (classe: Class) => {
    ...
    try {
      ...
      const studentsPromise = axios.get(`https://bethaniemiracle.com/api/classes/${classe.id}/students`, { 
        headers: { Authorization: `Bearer ${token}` }
      });
      const absencesPromise = axios.get(`https://bethaniemiracle.com/api/absences?class_id=${classe.id}&subject_id=${selectedSubject}&school_year=${selectedSchoolYear}`, { 
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleMediaUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://bethaniemiracle.com/api/media/upload', formData, {
        headers: { 
  ...
  const handleBulkMediaUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://bethaniemiracle.com/api/media/bulk-upload', formData, {
        headers: { 
          Authorization: `Bearer ${token}`,
          'Content-Type': 'multipart/form-data'
        }
  ...
  const handleSubmitAbsences = async () => {
    ...
    try {
      ...
      for (const [studentId, data] of Object.entries(absenceChanges)) {
        try {
          if (data.status === 'present') {
            ...
            await axios.post('https://bethaniemiracle.com/api/absences', {
      ...
      if (selectedClass) {
        try {
          const { data: absencesData } = await axios.get(`https://bethaniemiracle.com/api/absences?class_id=${selectedClass.id}&school_year=${selectedSchoolYear}`, { 
            headers: { Authorization: `Bearer ${token}` }
          });
  ...
  const loadTeacherSchedule = async () => {
    try {
      ...
      const { data } = await axios.get(`https://bethaniemiracle.com/api/schedules/teacher/${teacher.id}`, {
        headers: { Authorization: `Bearer ${token}` },
        params: { school_year: selectedSchoolYear }
      });
  ...
  const loadClassWeeklySchedule = async (classId: number) => {
    try {
      const token = localStorage.getItem('token');
      const { data } = await axios.get(`https://bethaniemiracle.com/api/schedules/weekly-schedule/${classId}`, {
        headers: { Authorization: `Bearer ${token}` },
        params: { school_year: selectedSchoolYear }
      });
  ...
  const handleViewWeeklySchedule = async (classe: Class) => {
    try {
      ...
      const { data } = await axios.get(`https://bethaniemiracle.com/api/schedules/weekly-schedule/${classe.id}`, {
        headers: { Authorization: `Bearer ${token}` },
        params: { school_year: selectedSchoolYear }
      });
  ...
  const handlePublishWeeklySchedule = async (classe: Class) => {
    try {
      ...
      const { data: weeklySchedules } = await axios.get(`https://bethaniemiracle.com/api/schedules/weekly-schedule/${classe.id}`, {
        headers: { Authorization: `Bearer ${token}` },
        params: { school_year: selectedSchoolYear }
      });
      ...
      const response = await axios.post('https://bethaniemiracle.com/api/schedules/publish-weekly-schedule', {
        teacher_id: teacher.id,
        class_id: classe.id,
        school_year: selectedSchoolYear,
  ...
  const handleCreateSchedule = async (startDate: Date, endDate: Date, description: string, dayOfWeek: string, domain: string, title: string) => {
    ...
    try {
      ...
      const existingSchedules = await axios.get(`https://bethaniemiracle.com/api/schedules/weekly-schedule/${selectedClassForSchedule.id}`, {
        headers: { Authorization: `Bearer ${token}` },
        params: { school_year: selectedSchoolYear }
      });
      ...
      const response = await axios.post('https://bethaniemiracle.com/api/schedules/create-weekly', payload, {
        headers: { Authorization: `Bearer ${token}` }
      });
                          ...
                          <Button
                            ...
                            onClick={async () => {
                              try {
                                ...
                                const { data: studentsData } = await axios.get(`https://bethaniemiracle.com/api/classes/${classe.id}/students`, { 
                                  headers: { Authorization: `Bearer ${token}` }
                                });
                                
                                // Charger les absences pour cette classe (sans matière spécifique)
                                const { data: absencesData } = await axios.get(`https://bethaniemiracle.com/api/absences?class_id=${classe.id}&school_year=${selectedSchoolYear}`, { 
                                  headers: { Authorization: `Bearer ${token}` }
                                });
                          ...
                          {/* <Button
                            ...
                            onClick={() => {
                              ...
                              const loadStudentsForMedia = async () => {
                                try {
                                  const token = localStorage.getItem('token');
                                  const { data } = await axios.get(`https://bethaniemiracle.com/api/classes/${classe.id}/students`, {
                                    headers: { Authorization: `Bearer ${token}` }
                                  });
                                  setStudents(data);
                                  setSelectedClass(classe);
