        ...
        <Box sx={{ 
          ...
          <Box sx={{
            ...
            <img
              ...
              alt="Groupe scolaire bethanie miracle"
              loading="eager"
              style={{
                width: '100%',
                height: '100%',
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Typography sx={{ fontSize: 'inherit' }}>
              Siège social: Abidjan, Cocody II Plateau Agban-Maternelle et primaire
            </Typography>
          </Box>
          ...
          <Box sx={{
            ...
            <Box sx={{
              ...
              <IconButton
                ...
                component="a"
                href="https://lapetiteacademie.ci:2096/"
                target="_blank"
          ...
          <Box sx={{ height: '100%' }}>
            ...
            {/* <Box sx={{ 
              ...
              <iframe
                ...
                title="La Petite Académie - Abidjan"
              />
            </Box> */}
          </Box>
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <Box sx={{ height: '100%' }}>
            ...
            <Box sx={{ 
              ...
              >
                Groupe Scolaire Béthanie Miracle
              </Typography>
              ...
              <Typography sx={{ 
                ...
                Le Groupe Scolaire Béthanie Miracle est une école sans disctinction de race ni de religion
              </Typography>
            ...
            <Box sx={{ 
              ...
              <Typography variant="body2" sx={{ opacity: 0.8 }}>
                Copyrights ® 2025 Groupe Scolaire Béthanie Miracle. All rights reserved
              </Typography>
            </Box>
          </Box>
        </Grid>
...
// Carousel traditionnel personnalisé
const TraditionalCarousel = memo(() => {
  ...
  const sliderImages = useMemo(() => [
    { 
      src: '/img/pages/imagede10.jpg', 
      alt: 'Pré-inscription',
      title: 'Bienvenue',
      subtitle: 'à',
      description: 'Groupe Scolaire Béthanie Miracle',
      type: 'scolarite'
    },
    { 
      src: '/img/pages/primaire3.jpg', 
      alt: 'Crèche - Garderie',
      title: '',
      subtitle: '',
      description: '',
      diferent: 'Un cadre d\'accueil propice au développement intellectuel, physique et émotionnel des enfants',
      type: 'creche'
    },
    { 
      src: '/img/pages/primaire4.jpg', 
      alt: 'Crèche - Garderie',
      title: '',
      subtitle: '',
      description: '',
      diferent: 'Nous proposons un programme bilingue orienté sur une approche alternative',
      type: 'creche'
    },
  ], []);

  // Préchargement simple des images
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % 3); // 3 images fixes
    }, 4000);
  ...
  const goToSlide = useCallback((index: number) => {
    ...
    // Reprendre l'auto-play après 5 secondes (réduit de 10s à 5s)
    setTimeout(() => setIsAutoPlaying(true), 5000);
  }, []);

  const goToPrevious = useCallback(() => {
    setCurrentSlide((prev) => (prev - 1 + 3) % 3); // 3 images fixes
    setIsAutoPlaying(false);
    setTimeout(() => setIsAutoPlaying(true), 5000);
  }, []);
  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{
            ...
            <Box sx={{
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  target.style.backgroundColor = '#1780c2';
        ...
        >
          <ArrowBackIosIcon sx={{ fontSize: { xs: 24, md: 28 } }} />
        </IconButton>
        ...
        >
          <ArrowForwardIosIcon sx={{ fontSize: { xs: 24, md: 28 } }} />
        </IconButton>
        ...
        <Box sx={{
          ...
          {sliderImages.map((_, index) => (
            ...
            >
              {currentSlide === index ? (
                <RadioButtonCheckedIcon sx={{ fontSize: { xs: 20, md: 24 } }} />
              ) : (
                <RadioButtonUncheckedIcon sx={{ fontSize: { xs: 20, md: 24 } }} />
              )}
            </IconButton>
          ))}
        </Box>

        {/* Overlay avec texte structuré */}
        <Box sx={{
          position: 'absolute',
          top: { xs: '20%', md: '40%' },
          left: '50%',
          ...
          {/* Description - "la Maison des Enfants - La Petite Académie" */}
          <Typography
            variant="h5"
            sx={{
              color: 'white',
              fontWeight: 400,
              fontSize: { xs: 16, md: 20, lg: 45 },
              textShadow: '2px 2px 4px rgba(0,0,0,0.7)',
              textAlign: 'center'
            }}
          >
          ...
          <Typography
            ...
            sx={{
              color: 'white',
              fontWeight: 'bold',
              fontSize: { xs: 16, md: 45, lg: 45 },
              textShadow: '2px 2px 4px rgba(0,0,0,0.7)',
              textAlign: 'center'
            }}
          >
            {sliderImages[currentSlide].diferent}
          </Typography>
        </Box>
      </Box>
    </Box>
...
const InfoSection = memo(() => {
  ...
  const cards = useMemo(() => [
    ...
    },
    {
      title: "MATERNELLE",
      paragraphs: [
        "La maternelle est le premier pas vers le monde scolaire. Au groupe scolaire bethanie miracle, nous mettons l'accent sur l'éveil intellectuel, la créativité et la socialisation.",
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 6 } }}>
        <Box sx={{
          ...
          <Box sx={{
            ...
            >
              Au Groype scolaire bethanie miracle, nous croyons fermement que chaque enfant possède un potentiel extraordinaire. Notre mission est de créer un environnement bienveillant, stimulant et sécurisé où chaque petit peut s'épanouir, découvrir et grandir à son rythme.
            </Typography>
            ...
            >
              Fondatrice/Directrice<br />
              Mme. Akéo Née Boka Marie-Flore
            </Typography>
          </Box>
  ...
  const activities = useMemo(() => [
    {
      ...
      image: "/img/pages/primaire1.jpg"
    },
    {
      title: "Cérémonie de graduation promotion 2025",
      image: "/img/pages/primaire2.jpg"
    },
    {
      title: "Instant conte",
      image: "/img/pages/primaire3.jpg"
    },
    {
      title: "Brunch Party",
      image: "/img/pages/primaire4.jpg"
    }
  ], []);
...
const Home = memo(() => {
  ...
  return (
    <>
      <Helmet>
        <title>Crèche Garderie Maternelle Primaire Bilingue Abidjan - Groupe Scolaire Béthanie Miracle</title>
        <meta name="description" content="Groupe Scolaire Béthanie Miracle : Crèche, garderie, maternelle et primaire bilingue à Abidjan Cocody II Plateau Agban. École sans distinction de race ni de religion, programme bilingue français-anglais, éveil et développement harmonieux des enfants. Inscription 2025-2026." />
        <meta name="keywords" content="crèche Abidjan, garderie Abidjan, école maternelle Abidjan, école primaire Abidjan, Groupe Scolaire Béthanie Miracle, programme bilingue, français-anglais, éveil intellectuel, développement harmonieux, pédagogie alternative, autonomie, bienveillance, activités ludiques, jeux éducatifs, initiation robotique, sorties éducatives, Cocody II Plateau Agban, école sans distinction" />
        <meta property="og:title" content="Crèche Garderie Maternelle Primaire Bilingue Abidjan - Groupe Scolaire Béthanie Miracle" />
        <meta property="og:description" content="Groupe Scolaire Béthanie Miracle : Crèche, garderie, maternelle et primaire bilingue à Abidjan Cocody II Plateau Agban. École sans distinction de race ni de religion, programme bilingue français-anglais, éveil et développement harmonieux des enfants." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bethaniemiracle.com" />
        <link rel="canonical" href="https://bethaniemiracle.com" />
      </Helmet>
      <Box sx={{ 
        width: '100%',
        margin: 0,
