          ...
          <Box sx={{ p: 3, maxHeight: '70vh', overflow: 'auto' }}>
              ...
              <Paper sx={{ p: 3, bgcolor: '#f8f9fa' }}>
                <List>
                  ...
                  <ListItem sx={{ display: 'flex', alignItems: 'flex-start' }}>
                    ...
                    <ListItemText primary="1 fiche d'identification à récupérer à La Petite Académie" />
                  </ListItem>
                  <ListItem sx={{ display: 'flex', alignItems: 'flex-start' }}>
                    <ListItemIcon>
                      <CheckCircleIcon sx={{ color: '#4caf50' }} />
                    </ListItemIcon>
                    <ListItemText primary="1 fiche sanitaire à récupérer à La Petite Académie" />
                  </ListItem>
                </List>
              </Paper>
            </Box>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell sx={{ bgcolor: '#f8f9fa' }} colSpan={5}>
                          A L'ORDRE DE LA MAISON DES ENFANTS-LA PETITE ACADEMIE
                        </TableCell>
                      </TableRow>
                      <TableRow>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell>
                          ...
                          <Typography variant="body2" sx={{ mb: 1 }}>
                            <strong>• Justificatif :</strong> Se présenter avec le justificatif du versement sur le compte, à la caisse de l'école de <strong>LA MAISON DES ENFANTS -LA PETITE ACADEMIE</strong> ou le transmettre par mail ou par WhatsApp dans un bref délais au service comptable <strong>(infos@lapetiteacademie.ci)</strong> afin de valider le paiement et rendre effective l'admission en classe.
                          </Typography>
                          <Typography variant="body2" sx={{ mb: 1 }}>
            ...
            <Box sx={{ textAlign: 'center', p: 3, bgcolor: '#f5f5f5', borderRadius: 2 }}>
              ...
              <Typography variant="body1" sx={{ mb: 1 }}>
                <strong>Adresse:</strong> Crèche-maternelle la Maison des enfants-la Petite Académie - Riviéra 3, Cité PALM-INDUSRIE, carrefour BON PASTEUR
              </Typography>
              <Typography variant="body1" sx={{ mb: 1 }}>
...
const ActivitesSection = () => {
  ...
  useEffect(() => {
    const loadActivities = async () => {
      try {
        setLoading(true);
        const response = await axios.get('https://bethaniemiracle.com/api/homepage/activities');
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          >
            ...
            j'ai donc décidé de faire profiter mes acquis aux enfants de mon pays. La Maison des Enfants 
            la Petite Académie, votre crèche et garderie de confiance à Abidjan, a donc vu le jour.
          </Typography>
  ...
  <Box sx={{ 
    ...
    <Container maxWidth="lg">
      <Typography variant="body2" sx={{ opacity: 0.8 }}>
        Copyrights ® 2025 La Maison des Enfants La petite Académie. All rights reserved
      </Typography>
    </Container>
  </Box>
);
              ...
              <Box component="ul" sx={{ pl: { xs: 1.5, md: 2 }, m: 0 }}>
                ...
                <Box component="li" sx={{ color: '#333' }}>
                  <Typography sx={{ 
                    ...
                    1 Fiche d'Identification et 1 fiche Sanitaire à récupérer à la Petite Académie
                  </Typography>
                </Box>
              </Box>
            </Box>
