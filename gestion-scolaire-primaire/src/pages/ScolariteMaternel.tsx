      ...
      <Container maxWidth="lg">
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              La maternelle est le premier pas vers le monde scolaire. À La Maison des Enfants - La petite académie, nous accueillons les enfants de{' '}
            ...
            <List sx={{ pl: 0 }}>
              ...
              <ListItem sx={{ px: 0, py: 0.5 }}>
                <ListItemText
                  primary="• 1 fiche d'identification et 1 fiche Sanitaire à récupérer à la Petite académie"
                  sx={{
                    '& .MuiListItemText-primary': {
                      fontSize: { xs: 14, md: 16 },
                      color: '#333',
...
const ScolariteMaternel = () => {
  return (
    <>
      <Helmet>
        <title>École Maternelle Bilingue Abidjan - La Petite Académie | Méthode Montessori</title>
        <meta name="description" content="École maternelle bilingue à Abidjan Cocody Riviera 3. La Petite Académie propose une pédagogie Montessori pour enfants de 3 à 6 ans avec programme français-anglais, éveil intellectuel et développement de l'autonomie. Inscription 2025-2026." />
        <meta name="keywords" content="école maternelle Abidjan, maternelle bilingue Cocody, méthode Montessori maternelle, programme français-anglais, éveil intellectuel, développement autonomie, inscription maternelle 2025, La Petite Académie, école privée Riviera 3, pédagogie alternative" />
        <meta property="og:title" content="École Maternelle Bilingue Abidjan - La Petite Académie | Méthode Montessori" />
        <meta property="og:description" content="École maternelle bilingue à Abidjan Cocody Riviera 3. La Petite Académie propose une pédagogie Montessori pour enfants de 3 à 6 ans avec programme français-anglais." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bethaniemiracle.com/scolarite-maternel" />
        <link rel="canonical" href="https://bethaniemiracle.com/scolarite-maternel" />
      </Helmet>
      <Box sx={{ 
        width: '100%',
        margin: 0,
