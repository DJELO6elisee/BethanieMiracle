      ...
      <Card sx={{ mt: 3 }}>
        <CardContent>
          ...
          <Box sx={{ fontFamily: 'monospace', fontSize: '0.8rem', bgcolor: '#f5f5f5', p: 1, borderRadius: 1 }}>
            <div>Étudiant: https://bethaniemiracle.com/api/students/photo/[filename]</div>
            <div>Garderie: https://bethaniemiracle.com/api/garderie/photo/[filename]</div>
            <div>Média: https://bethaniemiracle.com/api/media/[filename]</div>
          </Box>
