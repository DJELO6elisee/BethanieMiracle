# Documentation des Icônes PWA - La Petite Académie

## 📱 Génération des Icônes PWA à partir de vrailogo.jpg

### 🎯 Objectif
Remplacer toutes les anciennes icônes PWA par des nouvelles générées à partir du logo officiel `vrailogo.jpg`.
...
- `Students.tsx` - Logo des reçus étudiants
